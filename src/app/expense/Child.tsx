...
const HintDialog = (props: { open: boolean; onClose: () => void; type: HintType }) => {
  ...
  const renderContent = () => {
    switch (type) {
      case 'earlyEducation':
        return (
          <Stack spacing={2}>
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>幼稚園の学習費（年間平均）</Typography>
      ...
      case 'elementarySchool':
        return (
          <Stack spacing={2}>
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>小学校の学習費（年間平均）</Typography>
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ bgcolor: 'action.hover' }}>
      ...
      case 'juniorHighSchool':
        return (
          <Stack spacing={2}>
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>中学校の学習費（年間平均）</Typography>
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ bgcolor: 'action.hover' }}>
      ...
      case 'highSchool':
        return (
          <Stack spacing={2}>
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>高校の学習費（年間平均）</Typography>
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ bgcolor: 'action.hover' }}>
      ...
      case 'higherEducation':
        return (
          <Stack spacing={2}>
            <Typography variant="subtitle1" sx={{ fontWeight: 'bold' }}>大学の学習費（4年間合計）</Typography>
            <TableContainer component={Paper} variant="outlined">
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ bgcolor: 'action.hover' }}>
            ...
            <Divider />
            <Typography variant="subtitle2" color="primary" sx={{ fontWeight: 'bold' }}>医学部・歯学部（6年間）</Typography>
            <Typography variant="body2">
              ・国公立：約350万円
              <br />・私立：3,000万〜5,000万円超
            </Typography>
            <Typography variant="body2" color="text.secondary">
              私立大学理系が最も高額で、医学部・歯学部はさらに桁違いの費用がかかります。計画的な準備が推奨されます。
              <br />※出典：日本政策金融公庫「令和3年度教育費負担の実態調査」ほか
            </Typography>
          </Stack>
        )
      default:
  ...
  return (
    <Dialog onClose={onClose} open={open} maxWidth="sm" fullWidth>
      <DialogTitle sx={{ bgcolor: 'primary.main', color: 'primary.contrastText', mb: 1 }}>
        費用の目安
      </DialogTitle>
      <DialogContent>
        <Box sx={{ py: 1 }}>
                    ...
                    <Stack spacing={3}>
                            ...
                            <>
                              ...
                              <Box sx={{ width: '100%', mt: 0.5 }}>
                                <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                                  幼少期年額目安:{' '}
                                  {plan.earlyEducationType === 'kindergarten'
                                    ? ((plan.earlyEducationTuitionAmount ?? 0) + (plan.earlyEducationLessonsAmount ?? 0)).toLocaleString()
                                    : plan.earlyEducationType === 'nursery'
                                    ? `${((plan.nurseryTuitionAmountUnder3 ?? 0) + (plan.earlyEducationLessonsAmount ?? 0)).toLocaleString()} (0-2歳) / ${((plan.nurseryTuitionAmountOver3 ?? 0) + (plan.earlyEducationLessonsAmount ?? 0)).toLocaleString()} (3-5歳)`
                                    : 0}{' '}
                                  万円
                                </Typography>
                              </Box>
                      ...
                      <Stack spacing={3}>
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              小学校年額目安: {((plan.elementaryTuitionAmount ?? 0) + (plan.elementaryLessonsAmount ?? 0) + (plan.elementaryAllowanceAmount ?? 0)).toLocaleString()} 万円
                            </Typography>
                          </Box>
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              中学校年額目安: {((plan.juniorHighTuitionAmount ?? 0) + (plan.juniorHighLessonsAmount ?? 0) + (plan.juniorHighAllowanceAmount ?? 0)).toLocaleString()} 万円
                            </Typography>
                          </Box>
                        </Box>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              高校年額目安: {((plan.highSchoolTuitionAmount ?? 0) + (plan.highSchoolLessonsAmount ?? 0) + (plan.highSchoolAllowanceAmount ?? 0)).toLocaleString()} 万円
                            </Typography>
                          </Box>
                        </Box>
                      </Stack>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          {plan.higherEducationType !== 'none' && (
                            <>
                              ...
                              <Box sx={{ width: '100%', mt: 0.5 }}>
                                <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                                  高等教育年額目安: {((plan.higherEducationTuitionAmount ?? 0) + (plan.higherEducationLessonsAmount ?? 0)).toLocaleString()} 万円
                                </Typography>
                              </Box>
                            </>
                          )}
