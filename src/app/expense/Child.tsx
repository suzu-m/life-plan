...
import { HintDialog, type HintType } from '@/components/feature/expense/HintDialog'
                            ...
                            <>
                              ...
                              <Box sx={{ width: '100%', mt: 0.5 }}>
                                <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                                  ...
                                  {plan.earlyEducationType === 'kindergarten'
                                    ? (
                                        (plan.earlyEducationTuitionAmount ?? 0) +
                                        (plan.earlyEducationLessonsAmount ?? 0)
                                      ).toLocaleString()
                                    : plan.earlyEducationType === 'nursery'
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              小学校年額目安:{' '}
                              {(
                                (plan.elementaryTuitionAmount ?? 0) +
                                (plan.elementaryLessonsAmount ?? 0) +
                                (plan.elementaryAllowanceAmount ?? 0)
                              ).toLocaleString()}{' '}
                              万円
                            </Typography>
                          </Box>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              中学校年額目安:{' '}
                              {(
                                (plan.juniorHighTuitionAmount ?? 0) +
                                (plan.juniorHighLessonsAmount ?? 0) +
                                (plan.juniorHighAllowanceAmount ?? 0)
                              ).toLocaleString()}{' '}
                              万円
                            </Typography>
                          </Box>
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <Box sx={{ width: '100%', mt: 0.5 }}>
                            <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                              高校年額目安:{' '}
                              {(
                                (plan.highSchoolTuitionAmount ?? 0) +
                                (plan.highSchoolLessonsAmount ?? 0) +
                                (plan.highSchoolAllowanceAmount ?? 0)
                              ).toLocaleString()}{' '}
                              万円
                            </Typography>
                          </Box>
                            ...
                            <>
                              ...
                              <Box sx={{ width: '100%', mt: 0.5 }}>
                                <Typography variant="caption" color="primary" sx={{ fontWeight: 'bold' }}>
                                  高等教育年額目安:{' '}
                                  {(
                                    (plan.higherEducationTuitionAmount ?? 0) + (plan.higherEducationLessonsAmount ?? 0)
                                  ).toLocaleString()}{' '}
                                  万円
                                </Typography>
                              </Box>
